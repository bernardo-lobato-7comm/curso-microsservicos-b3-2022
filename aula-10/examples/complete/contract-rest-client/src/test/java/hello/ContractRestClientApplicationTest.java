...
public class ContractRestClientApplicationTest {
	...
	public void get_person_from_service_contract() {
		...
		BDDAssertions.then(personResponseEntity.getBody().getName()).isEqualTo("outro nome versão 4");
		BDDAssertions.then(personResponseEntity.getBody().getSurname()).isEqualTo("bee versão 4");
